...
For a code-grounded explanation of the current workspace setup, model selection, extraction flow, and processed-paper counts, see [docs/workspace_overview.md](docs/workspace_overview.md).
...
karma process document.pdf --api-key YOUR_OPENROUTER_KEY --output results.json

# Process with custom settings
karma process document.pdf --api-key YOUR_KEY --model deepseek/deepseek-v3.2 \\
...
config = create_default_config(api_key="your-openrouter-api-key")
...
- OpenRouter/OpenAI for providing the LLM infrastructure
